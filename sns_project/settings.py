...
SECRET_KEY = 'django-insecure-r*vh(w65stp+ax02rzo%@@=-4do!csnhp6_a7u=o$)696na+i$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'basic', 'templates'), os.path.join(BASE_DIR, 'templates', 'account')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
